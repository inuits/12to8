...
/*AttachmentsListOK handles this case with default header values.

AttachmentsListOK attachments list o k
*/
type AttachmentsListOK struct {
}

func (o *AttachmentsListOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/attachments/][%d] attachmentsListOK ", 200)
}
